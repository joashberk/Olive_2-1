  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark-800 rounded-xl max-w-md w-full shadow-2xl border border-dark-700">
          ...
          <div className="p-6">
            <div className="space-y-2 mb-6">
              ...
              >
                <div className="w-5 h-5 rounded border border-olive-500 flex items-center justify-center">
